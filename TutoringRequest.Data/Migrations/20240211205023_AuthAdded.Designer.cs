...
namespace TutoringRequest.Data.Migrations
{
    ...
    [Migration("20240211205023_AuthAdded")]
            ...
            modelBuilder.Entity("TutoringRequest.Models.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2475a1c9-052d-4b39-a6c6-8cad2ab23690"),
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = new Guid("0a8fcf80-e28a-4591-925f-e233f4ab2ebb"),
                            RoleName = "Student"
                        },
                        new
                        {
                            Id = new Guid("055ecbca-854b-4cad-b47d-b51d3da3ad73"),
                            RoleName = "Tutor"
                        });
                });
